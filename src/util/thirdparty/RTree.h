...
///
/// NOTES: Inserting and removing data requires the knowledge of its constant std::minimal Bounding Rectangle.
...
protected:
  ...
  /// std::minimal bounding rectangle (n-dimensional)
  struct Rect
  {
...
}}/// end of namespace klib { end of namespace thirdRtree
