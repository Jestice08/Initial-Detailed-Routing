...
public:
    ...
    bool    adjacent(const XYZ<XYType, ZType> &other) const
    {
        return (klib::absDif<XYType>(this->x(), other.x()) + klib::absDif<XYType>(this->y(), other.y()) + klib::absDif<ZType>(this->z(), other.z())) == 1;
    }
