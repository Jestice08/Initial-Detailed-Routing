      ...
      for(int l=0; l< upperGuideArray.size(); l++){  // for each guide, find if has same net first,if yes then output overlay apcs
        ...
        if(sameNetarray.begin()!=sameNetarray.end()){ //for every common net, create one apc
          for(int m = 0;m<sameNetarray.size();m++){
            ...
            cout << "APC size : " << ApcCreated.aps.size()<< endl;
            cout <<"ApcCreated.aps.xCoordinate :"<< ApcCreated.aps[0].xCoordinate<< "  " <<"ApcCreated.aps.yCoordinate :"<< ApcCreated.aps[0].yCoordinate << endl;
            cout <<"ApcCreated.aps.xCoordinate :"<< ApcCreated.aps[ApcCreated.aps.size()-1].xCoordinate<< "  " <<"ApcCreated.aps.yCoordinate :"<< ApcCreated.aps[ApcCreated.aps.size()-1].yCoordinate << endl;
